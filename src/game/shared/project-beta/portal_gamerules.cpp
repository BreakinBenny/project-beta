...
/*
Newer code (sound.cpp) silents the radios in maps a_00, a_11, and a_14. 
Just make it return false, as it must be from the update from 2010. -reep
*/

//-----------------------------------------------------------------------------
// Remove radios without touching maps?
//-----------------------------------------------------------------------------
bool CPortalGameRules::ShouldRemoveRadio()
{
	return false;
}
#endif
