...
{
	// Check the time!
	//if (PortalGameRules()) { PortalGameRules()->EarlyInYear(); }
...
void ClientGamePrecache( void )
{
	...
	CBaseEntity::PrecacheModel("models/weapons/portalblast/portalblast_reference.mdl");
	CBaseEntity::PrecacheModel("models/weapons/portalblast/portalblast2_reference.mdl");
}
