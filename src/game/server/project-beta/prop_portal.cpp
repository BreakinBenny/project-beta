...
#include "project-beta/weapon_physcannon.h"
...
CProp_Portal::CProp_Portal( void )
{
	...
	oldgun = PortalGameRules() && PortalGameRules()->EarlyInYear() == true; 
}
...
void CProp_Portal::Precache( void )
{
	...
	// x06
	PrecacheParticleSystem("portal_1_overlap_x06");
	PrecacheParticleSystem("portal_2_overlap_x06");
	PrecacheParticleSystem("portal_1_badvolume_x06");
	PrecacheParticleSystem("portal_2_badvolume_x06");
	PrecacheParticleSystem("portal_1_badsurface_x06");
	PrecacheParticleSystem("portal_2_badsurface_x06");
	PrecacheParticleSystem("portal_1_close_x06");
	PrecacheParticleSystem("portal_2_close_x06");
	PrecacheParticleSystem("portal_1_cleanser_x06");
	PrecacheParticleSystem("portal_2_cleanser_x06");
	PrecacheParticleSystem("portal_1_near_x06");
	PrecacheParticleSystem("portal_2_near_x06");
...
void CProp_Portal::DoFizzleEffect( int iEffect, bool bDelayedPos /*= true*/ )
{
	...
	switch ( iEffect )
	{
		...
		case PORTAL_FIZZLE_OVERLAPPED_LINKED:
		{
			...
			{
				DispatchParticleEffect(((m_bIsPortal2) ? ("portal_2_overlap_x06") : ("portal_1_overlap_x06")), fxData.m_vOrigin, fxData.m_vAngles, this);
			}
			ep.m_pSoundName = "Portal.fizzle_invalid_surface";
			break;
		}
		...
		case PORTAL_FIZZLE_BAD_VOLUME:
			...
			{
				DispatchParticleEffect(((m_bIsPortal2) ? ("portal_2_badvolume_x06") : ("portal_1_badvolume_x06")), fxData.m_vOrigin, fxData.m_vAngles);
			}
			ep.m_pSoundName = "Portal.fizzle_invalid_surface";
			break;
		...
		case PORTAL_FIZZLE_BAD_SURFACE:
			...
			{
				DispatchParticleEffect(((m_bIsPortal2) ? ("portal_2_badsurface_x06") : ("portal_1_badsurface_x06")), fxData.m_vOrigin, fxData.m_vAngles);
			}
			ep.m_pSoundName = "Portal.fizzle_invalid_surface";
			break;
		...
		case PORTAL_FIZZLE_KILLED:
			...
			{
				DispatchParticleEffect(((m_bIsPortal2) ? ("portal_2_close_x06") : ("portal_1_close_x06")), fxData.m_vOrigin, fxData.m_vAngles);
			}
		...
		case PORTAL_FIZZLE_CLEANSER:
			...
			{
				DispatchParticleEffect(((m_bIsPortal2) ? ("portal_2_cleanser_x06") : ("portal_1_cleanser_x06")), fxData.m_vOrigin, fxData.m_vAngles, this);
			}
			ep.m_pSoundName = "Portal.fizzle_invalid_surface";
			break;
		...
		case PORTAL_FIZZLE_NEAR_BLUE:
		{
			...
			{
				DispatchParticleEffect(((m_bIsPortal2) ? ("portal_2_near_x06") : ("portal_1_near_x06")), fxData.m_vOrigin, fxData.m_vAngles);
			}
			ep.m_pSoundName = "Portal.fizzle_invalid_surface";
			break;
		}
